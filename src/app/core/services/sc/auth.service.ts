...
export class AuthService {
  ...
  constructor(private http: HttpClient, public router: Router, private base: BaseService,private localService:LocalService) {
    this.currentUserSubject = new BehaviorSubject<User>(
      // JSON.parse(localStorage.getItem('user')!)
      JSON.parse(this.localService.getData('enkusr')!)
    );
